...
namespace WindowsFormsAppSubtitle
{
    ...
    public class StrHelperTR
    {
        //Define a list of ModelList to accept the content read from the file
        private static List<StrModelTR> mySrtModelList;
        ...
        public static string GetTimeString(int timeMile)
        {
            ...
            {
                foreach (StrModelTR sm in mySrtModelList)
                {
        ...
        public static List<StrModelTR> ParseSrt(string srtPath)
        {
            mySrtModelList = new List<StrModelTR>();
            string line;
        ...
        {
            return UseRegex(StrHelperTR.GetTimeString(int.Parse(Change(title))));
        }
